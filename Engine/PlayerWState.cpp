...
PlayerWState::PlayerWState(shared_ptr<ModelAnimator> modelAnimator)
...
PlayerWState::~PlayerWState()
{

}

void PlayerWState::Enter()
{
    m_skillTime = 0.0f;
...
bool PlayerWState::CanTransitionTo(PlayerStateType newState)
{
