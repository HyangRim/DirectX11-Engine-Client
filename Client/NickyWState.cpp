...
void NickyWState::Enter(shared_ptr<ModelAnimator> animator)
{
    if (!animator)
        return;
...
void NickyWState::Update(shared_ptr<ModelAnimator> animator)
{
    if (!animator)
        return;
...
void NickyWState::Exit(shared_ptr<ModelAnimator> animator)
{
    if (!animator)
        return;
...
bool NickyWState::CanTransitionTo(AnimationStateType nextState)
{
