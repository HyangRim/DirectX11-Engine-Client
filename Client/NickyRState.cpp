...
void NickyRState::Enter(shared_ptr<ModelAnimator> animator)
{
    if (!animator)
        return;
...
void NickyRState::Update(shared_ptr<ModelAnimator> animator)
{
    if (!animator)
        return;
...
void NickyRState::Exit(shared_ptr<ModelAnimator> animator)
{
    if (!animator)
        return;
...
bool NickyRState::CanTransitionTo(AnimationStateType nextState)
{
